...
`npm run audit:production` reports no advisories for production dependencies. The
full tree reports low-severity entries from the unpatched development dependency
`elliptic` ([GHSA-848j-6mx2-7j84 / CVE-2025-14505](https://github.com/advisories/GHSA-848j-6mx2-7j84))
in the Hardhat 2 fork toolchain only. The production SDK resolves ethers 6.17.
...
transaction. See the test source for details.
...
[credits](PROVENANCE.md) and [citation metadata](CITATION.cff).
